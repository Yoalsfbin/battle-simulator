...
function generateEnemies(enemiesCount) {
  // 敵のパラメータ
  var enemyParams = [
    { hp: 10, name: "アメーバ", minAttack: 3, maxAttack: 8, image: './img/enemy1.PNG' }, 
    { hp: 20, name: "いたずらねずみ", minAttack: 5, maxAttack: 10, image: './img/enemy2.PNG' }, 
    { hp: 25, name: "おばけどり", minAttack: 8, maxAttack: 15, image: './img/enemy3.PNG' } 
  ];
...
function generateBossEnemies() {
  // 敵のパラメータ
  var enemyParams = [
    { hp: 120, name: "ドラゴン", minAttack: 20, maxAttack: 30, image: './img/boss.PNG' }, 
  ];
